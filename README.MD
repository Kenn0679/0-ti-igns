...
> **Screenshot:** Replace this line with a terminal screenshot of `check_store.py` output showing OptiBot answering with properly formatted `Article URL:` citations.
